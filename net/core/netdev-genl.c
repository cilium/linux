...
int netdev_nl_queue_create_doit(struct sk_buff *skb, struct genl_info *info)
{
	...
	/* Leasing queues from different devices is currently not
	 * possible. Advertised features from the netdev itself might
	 * need recomputation to gather the supported intersection.
	 */
