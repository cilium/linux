...
|               **getname4** | **getname6** | **sendmsg4** | **sendmsg6** | **recvmsg4** | **recvmsg6** |
...
===========
	...
	**bpftool cgroup attach** *CGROUP* *ATTACH_TYPE* *PROG* [*ATTACH_FLAGS*]
		  ...
		  **getname4** call to getpeername(2)/getsockname(2) for an inet4 socket (since 5.8);
		  **getname6** call to getpeername(2)/getsockname(2) for an inet6 socket (since 5.8).
