...
bpf_lsm_func_proto(enum bpf_func_id func_id, const struct bpf_prog *prog)
{
	...
	case BPF_FUNC_sb_storage_get:
		return &bpf_sb_storage_get_proto;
	case BPF_FUNC_sb_storage_delete:
		return &bpf_sb_storage_delete_proto;
#ifdef CONFIG_NET
...
BTF_ID(func, bpf_lsm_inode_copy_up)
...
BTF_ID(func, bpf_lsm_inode_get_label)
BTF_ID(func, bpf_lsm_inode_init_label)
BTF_ID(func, bpf_lsm_inode_link)
BTF_ID(func, bpf_lsm_inode_listxattr)
BTF_ID(func, bpf_lsm_inode_list_labels)
BTF_ID(func, bpf_lsm_inode_mkdir)
